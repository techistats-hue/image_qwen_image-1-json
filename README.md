# image_qwen_image-1-json

Dockerized ComfyUI workflow: image_qwen_image[1].json
...
docker build -t image_qwen_image-1-json .

# Run the container
docker run -p 8188:8188 image_qwen_image-1-json
```
